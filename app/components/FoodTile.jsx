    ...
    <TouchableOpacity style={styles.wrapper} onPress={showDetails}>
       <View style={{backgroundColor: COLORS.lightWhite, borderRadius: 12}}>
              <View style={{ flexDirection: 'row' }}>
                  ...
                  <View style={{ position: 'absolute', right: 5, backgroundColor: COLORS.primary, borderRadius: 9, top: 5}}>
                    <Text style={[styles.title, {color: COLORS.lightWhite, marginHorizontal: 5}]}>Kshs {item.price}</Text>
                  </View>
