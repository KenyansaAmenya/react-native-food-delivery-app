...
const FoodPage = ({route, navigation}) => {
  ...
  // Function for additives & Toppings
  const handleAdditives = (newAdditive) => {
    setAdditives((prevAdditives) => {
      // Check if the new additive already exists in the array
  ...
  // useEffect to recalculate price when additives change
  useEffect(() => {
    calculatePrice();
  }, [additives])
          ...
          <View style={styles.cart}>
            <View style={styles.cartRow}>
              <TouchableOpacity onPress={() => {}} style={styles.cartbtn}>
                 <AntDesign name='pluscircle' size={24} color={COLORS.lightWhite}/>
              </TouchableOpacity>
